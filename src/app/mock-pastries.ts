...
export const PASTRIES: Pastrie[] = [
  ...
  },
  {
    ...
    quantity: 4,
    order: 3,
    tags: ["sucré", "yummy", "dessert", "chocolat", "framboises"],
  },
  {
    id: "4",
    ref: "Viennoiserie",
...
export const INGREDIENTS_LISTS = [
  {
    id: "1",
